    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 select-none">
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-2xs">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-bold text-zinc-950 dark:text-white">{activeRoomsCount}</span>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-2xs">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-bold text-zinc-950 dark:text-white">{totalMembersCount}</span>
          <span className="text-[11px] font-medium text-zinc-400 dark:text-zinc-500">Online</span>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-2xs">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-bold text-zinc-950 dark:text-white">0.01s</span>
          <span className="text-[11px] font-semibold text-emerald-600 dark:text-emerald-400">Locked</span>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-2xs">
        <div className="flex items-center justify-between text-zinc-500 dark:text-zinc-400 text-xs font-medium">
          ...
          <Tv className="w-3.5 h-3.5 text-zinc-400 dark:text-zinc-500" />
        </div>
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-bold text-zinc-950 dark:text-white">1080p</span>
          <span className="text-[11px] font-medium text-zinc-400 dark:text-zinc-500">60 FPS</span>
        </div>
      </div>
    </div>
  );
