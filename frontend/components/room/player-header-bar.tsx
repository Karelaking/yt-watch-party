...
export function PlayerHeaderBar({
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 bg-zinc-900/95 backdrop-blur-md border-b border-zinc-800 text-xs z-30">
      ...
      <div className="flex items-center gap-2">
        {hasScreenStream && (
          <div className="flex items-center gap-1 bg-zinc-800 p-0.5 rounded-lg text-[10px] font-bold">
            <button
              type="button"
        ...
        {canControl && (
          <button
            ...
            className="text-[11px] text-zinc-400 hover:text-white bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 rounded transition-colors cursor-pointer"
          >
            Change URL
          </button>
        )}
