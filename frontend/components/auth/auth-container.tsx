...
export function AuthContainer({
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-12 bg-white dark:bg-zinc-950 text-zinc-950 dark:text-zinc-100 font-sans selection:bg-zinc-900 selection:text-white"
    >
      ...
      <div className="lg:col-span-5 xl:col-span-5 flex flex-col justify-between p-6 sm:p-10 lg:p-12 min-h-screen bg-white dark:bg-zinc-950 relative overflow-y-auto">
        {/* Top Header Navigation */}
        <div className="auth-header-nav flex items-center justify-between w-full pb-6 border-b border-zinc-100 dark:border-zinc-800">
          <Link
            href="/"
            className="group inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold text-zinc-700 dark:text-zinc-300 bg-zinc-100/90 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-950 hover:text-white dark:hover:bg-white dark:hover:text-zinc-950 hover:border-zinc-950 dark:hover:border-white transition-all duration-200 cursor-pointer shadow-2xs"
          >
        ...
        <div className="auth-form-card my-auto py-8 w-full max-w-md mx-auto">
          {/* Segmented Switcher */}
          <div className="mb-6 p-1 rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 grid grid-cols-2 text-center text-xs font-semibold select-none shadow-inner">
            <Link
              href="/sign-in"
              className={cn(
                "py-2.5 rounded-xl transition-all duration-200 cursor-pointer flex items-center justify-center gap-1.5",
                mode === "sign-in"
                  ? "bg-white dark:bg-zinc-800 text-zinc-950 dark:text-white shadow-md shadow-zinc-950/5 font-bold"
                  : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-white/50 dark:hover:bg-zinc-800/50"
              )}
            >
              <span>Sign In</span>
            </Link>
        ...
        <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-zinc-400">
