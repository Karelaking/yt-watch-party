  ...
  return (
    ...
    >
      ...
      <div className="hero-heading-block max-w-7xl mx-auto px-4 my-16 sm:my-20">
        ...
        >
          ...
          <div className="hero-title-line-1 flex items-center justify-center flex-wrap gap-x-2 sm:gap-x-3.5 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[70px] font-extrabold tracking-tight leading-[1.12]">
            <span className="hero-word text-zinc-950 inline-block">Watch</span>
            <span className="hero-pill pill-highlight text-zinc-950 inline-block">
              Together
            </span>
            <span className="hero-word text-zinc-400 font-medium inline-block">
              and
            </span>
            <span className="hero-word text-zinc-400 font-medium inline-block">
              Sync
          ...
          <div className="hero-title-line-2 flex items-center justify-center flex-wrap gap-x-2 sm:gap-x-3.5 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[70px] font-extrabold tracking-tight leading-[1.12]">
            <span className="hero-word text-zinc-950 inline-block">Moments</span>
            ...
            <span className="hero-word text-zinc-950 inline-block">With</span>
            <span className="hero-word text-zinc-950 inline-block">Your</span>
            <span className="hero-word text-zinc-950 inline-block">Friends!</span>
          </div>
        </HighlightHeading>
      </div>

      {/* Subtitle */}
      <p className="hero-subtext max-w-xl mx-auto mt-6 text-sm sm:text-base text-zinc-500 font-normal leading-relaxed">
      ...
      <div className="relative w-full max-w-6xl mt-12 sm:mt-16 min-h-115 sm:min-h-130 md:min-h-140 flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-radial from-zinc-200/50 via-transparent to-transparent blur-3xl pointer-events-none -z-10" />
        ...
        <div className="hero-floating-card relative z-20 mx-auto">
          <div className="hero-card-center">
            <FloatingCard
              rotate={0}
              className="p-4 sm:p-5 shadow-2xl border-zinc-300/80 bg-white"
            >
              <VideoPlayerMock />
            </FloatingCard>
          </div>
