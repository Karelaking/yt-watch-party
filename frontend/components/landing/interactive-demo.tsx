...
export function InteractiveDemo(): React.JSX.Element {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full max-w-4xl mx-auto rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200/90 dark:border-zinc-800 p-6 sm:p-10 shadow-2xl shadow-zinc-950/5 dark:shadow-black/50 select-none"
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-zinc-600 dark:text-zinc-300 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-full px-3.5 py-1.5 self-start sm:self-auto">
      ...
      {/* Preset Suggestions */}
      <div className="my-6">
        <span className="text-xs font-semibold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider block mb-2.5">
          Popular Presets
        </span>
        <div className="flex flex-wrap gap-2">
          {sampleVideos.map((sample, idx) => (
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-zinc-50 dark:bg-zinc-800/80 hover:bg-zinc-100 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700/80 text-zinc-700 dark:text-zinc-300 transition-all hover:scale-102 cursor-pointer"
            >
              <span>{sample.category}</span>
              <span className="font-semibold text-zinc-900 dark:text-white">{sample.title}</span>
            </button>
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-xs sm:text-sm text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 focus:bg-white dark:focus:bg-zinc-900 transition-all font-mono disabled:opacity-60"
              required
            />
            {errors.youtubeUrl && (
              <p id="demo-youtube-url-error" className="text-[11px] text-red-600 dark:text-red-400 font-medium px-1">
                {errors.youtubeUrl}
              </p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            <label
              ...
              className="text-xs font-semibold text-zinc-700 dark:text-zinc-300 flex items-center gap-1.5"
            >
              <Users className="w-3.5 h-3.5 text-zinc-900 dark:text-white" /> Party Room Name
            </label>
            <input
              id="demo-room-name"
              type="text"
              ...
              className="w-full px-4 py-2.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-xs sm:text-sm text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 focus:bg-white dark:focus:bg-zinc-900 transition-all disabled:opacity-60"
              required
            />
            {errors.roomName && (
              <p id="demo-room-name-error" className="text-[11px] text-red-600 dark:text-red-400 font-medium px-1">
                {errors.roomName}
              </p>
            )}
          </div>
