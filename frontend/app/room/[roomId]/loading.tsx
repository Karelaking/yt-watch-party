...
export default function RoomLoading(): React.JSX.Element {
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col font-sans">
      {/* Top Header Skeleton */}
      <div className="h-14 border-b border-zinc-800/80 bg-zinc-900/60 px-4 flex items-center justify-between animate-pulse">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 grid grid-cols-1 lg:grid-cols-12 gap-4 items-start animate-pulse">
        ...
        <div className="lg:col-span-8 space-y-3">
          <div className="aspect-video w-full rounded-2xl bg-zinc-900 border border-zinc-800/80 flex items-center justify-center">
            <div className="h-10 w-10 rounded-full border-2 border-zinc-700 border-t-white animate-spin" />
          </div>
          <div className="h-12 rounded-xl bg-zinc-900 border border-zinc-800/80" />
        </div>

        {/* Sidebar Skeleton (4 cols) */}
        <div className="lg:col-span-4 h-140 rounded-2xl bg-zinc-900 border border-zinc-800/80 p-3 space-y-3">
          <div className="h-8 rounded-lg bg-zinc-800" />
          <div className="h-96 rounded-lg bg-zinc-950/40" />
