  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-50/50 text-zinc-950 font-sans">
      ...
      <div className="h-16 border-b border-zinc-200/80 bg-white/80 px-6 flex items-center justify-between animate-pulse">
        ...
        <div className="h-8 w-64 rounded-full bg-zinc-100 hidden sm:block" />
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 py-6 space-y-6 animate-pulse">
        <div className="flex justify-between items-center">
          ...
          <div className="h-8 w-48 rounded bg-zinc-200 hidden sm:block" />
        </div>

        {/* Stats Strip Skeleton */}
        <div className="h-20 rounded-2xl bg-zinc-200/60" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div
              key={i}
              className="h-64 rounded-2xl bg-white border border-zinc-200/80 p-4 space-y-3"
            >
